  ...
  return (
    <div className="bg-white dark:bg-[#0f1118]">
      <section className="mx-auto flex min-h-[52vh] max-w-3xl flex-col items-center justify-center px-4 py-16 text-center sm:px-6 lg:px-8">
        ...
        <p className="mt-5 text-base leading-7 text-slate-600 dark:text-slate-400">{description}</p>
        {details.length > 0 && (
          <div className="mt-6 space-y-4 text-left text-sm leading-6 text-slate-600 dark:text-slate-400">
            {details.map((detail) => (
