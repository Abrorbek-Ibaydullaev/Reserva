...
const NotFound = () => {
  ...
  return (
    <>
      <SEO title="Page Not Found" description="The page you were looking for could not be found on Reserva." noindex />
      ...
      <div className="mx-auto flex max-w-3xl flex-col items-center justify-center rounded-3xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-8 py-16 text-center shadow-sm">
        ...
        <h1 className="mt-6 text-4xl font-bold text-gray-900 dark:text-white">{t('not_found.title')}</h1>
