...
# Email settings
# If EMAIL_HOST_USER is provided in .env, use real SMTP (Gmail).
# Otherwise fall back to console output so dev works without credentials.
...
if _email_host_user:
    ...
    EMAIL_HOST_USER = ''
    EMAIL_HOST_PASSWORD = ''
    DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@reserva.uz')
